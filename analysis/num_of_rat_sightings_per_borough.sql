SELECT DISTINCT date_dim_id, date_dim.full_date, location_dim_id, location_dim_id.borough, agency_dim_id, complaint_dim_id,
count(complaint_dim_id) as complaint_count
...
GROUP BY date_dim_id, location_dim_id, agency_dim_id, complaint_dim_id, date_dim.full_date
